...
const DrawerCompany: React.FC<DrawerProps> = ({ title, content, size }) => {
  const showDrawer = useDashboardStore((state) => state.showDrawerCompany);
  const toggle = useDashboardStore((state) => state.toggleDrawerCompany);
